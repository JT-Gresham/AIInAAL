...
#  Copy files (without overwritting) from my custom preset directory (Auto1111_Presets) I created in the AIInAAL shared folder
#cp --no-clobber -R shared/presets/Auto1111/* Auto1111/presets/

#  Change into the Auto1111 directory for the next part.
#cd Auto1111/modules

#  Since my name is both capital letters, I need to make a change into a Auto1111 file so it will recognize my name as "JT" ...not "Jt" (only if needed)
...
#  Lastly, I want Auto1111 to make sure to add my styles only if needed...the 'if' statement makes sure there isn't duplicate lines of code added. 
