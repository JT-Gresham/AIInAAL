...
cd custom_nodes
git clone https://github.com/ltdrdata/Auto1111-Manager Auto1111-manager
...
echo "Installation complete. Start with command: AIInAAL-$aiinaalpkg with any Auto1111 arguments afterward"
