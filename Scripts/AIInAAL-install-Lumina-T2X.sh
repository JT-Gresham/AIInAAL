...
echo "python $AIInAALdir/$aiinaalpkg/lumina-t2i/entry_point.py" >> $AIInAALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
#echo "sleep 60"
...
echo "Installation complete. Start with command: AIInAAL-$aiinaalpkg with any Lumina-T2X arguments afterward"
