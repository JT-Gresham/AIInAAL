...
echo "sleep 60"
#echo "echo "SimpleSDXL is still running in the background. Enter command: SimpleSDXL-exit to close down SimpleSDXL.""
#echo "" >> $AIInAALdir/$aiinaalpkg/$aiinaalpkg-Start.sh
...
echo "Installation complete. Start with command: AIInAAL-$aiinaalpkg with any SimpleSDXL arguments afterward"
