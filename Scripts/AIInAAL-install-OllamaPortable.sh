...
sudo echo "#!/usr/bin/env bash" > /usr/bin/ollama
sudo echo "" >> /usr/bin/ollama
sudo echo "set -e" >> /usr/bin/ollama
sudo echo "exec $AIInAALdir/AIInAAL_env/lib/python3.11/site-packages/ollama/ollama /"/$/@/"" >> /usr/bin/ollama
