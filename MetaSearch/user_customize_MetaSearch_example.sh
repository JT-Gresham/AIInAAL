...
####  This file is for you to add any code you want to execute just before MetaSearch launches.  This will not be updated when AIInAAL or MetaSearch updates.
...
#  Copy files (without overwritting) from my custom preset directory (MetaSearch_Presets) I created in the AIInAAL shared folder
